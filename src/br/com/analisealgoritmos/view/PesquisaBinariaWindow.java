...
public class PesquisaBinariaWindow extends AbstractWindowFrame{
	
	private static final long serialVersionUID = -4767278455401621130L;
	...
	public PesquisaBinariaWindow(JDesktopPane desktop) {
		super("Algoritmo de Pesquisa Binária");
