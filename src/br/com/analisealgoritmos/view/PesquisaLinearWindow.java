...
public class PesquisaLinearWindow extends AbstractWindowFrame{

	private static final long serialVersionUID = 6734012441446944480L;
	...
	public PesquisaLinearWindow(JDesktopPane desktop) {
		super("Algoritmo de Pesquisa Linear");
